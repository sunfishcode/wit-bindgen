...
suffix=_wit_bindgen_$version

cat >./crates/guest-rust/rt/src/cabi_realloc.rs <<-EOF
// This file is generated by $0

#[no_mangle]
pub unsafe extern "C" fn cabi_realloc$suffix(
    old_ptr: *mut u8,
    old_len: usize,
    align: usize,
    new_len: usize,
...
#[no_mangle]
pub unsafe extern "C" fn cabi_stream_buffer$suffix(
    old_ptr: *mut u8,
    old_len: usize,
    align: usize,
    new_len: usize,
...
extern void *cabi_realloc$suffix(void *ptr, size_t old_size, size_t align, size_t new_size);
extern void *cabi_stream_buffer$suffix(void *ptr, size_t old_size, size_t align, size_t new_size);

__attribute__((__weak__, __export_name__("cabi_realloc")))
void *cabi_realloc(void *ptr, size_t old_size, size_t align, size_t new_size) {
  return cabi_realloc$suffix(ptr, old_size, align, new_size);
}
...
void *cabi_stream_buffer(void *ptr, size_t old_size, size_t align, size_t new_size) {
  return cabi_stream_buffer$suffix(ptr, old_size, align, new_size);
}
EOF
